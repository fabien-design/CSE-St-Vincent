...
<aside class="left">
            ...
            <div class="infocontact">
                ...
                <div class="email">
                    <p>
                        <img src="assets/chevron-droit.png" class="chevron-droit" alt="chevron-droit">>Par email : <a target="_blank"
                            href="mailto:cse@lyceestvincent.fr"><?= $adresseEmail ?></a>
                    </p>
                </div>
                <div class="place">
                    <p><img src="assets/chevron-droit.png" class="chevron-droit" alt="chevron-droit">>Au lycée : <a target="_blank"
